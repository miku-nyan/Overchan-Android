...
public class GalleryFullscreen implements View.OnSystemUiVisibilityChangeListener, GalleryActivity.FullscreenCallback {
    ...
    private GalleryFullscreen(Activity activity) {
        handler = new Handler();
    ...
    public static void initFullscreen(GalleryActivity activity) {
        activity.setFullscreenCallback(new GalleryFullscreen(activity));
    }
}
