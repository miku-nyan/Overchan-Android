 ...
 * Убрана возможность работы с android.support.v7.widget.Toolbar, чтобы не тянуть саму support-v7
 * 
 */
    ...
    public void setHomeAsUpIndicator(int resId) {
        ...
        if (resId != 0) {
            indicator = //mDrawerLayout.getResources().getDrawable(resId);
                    ResourcesCompat.getDrawable(mDrawerLayout.getResources(), resId, null);
        }
