/*
 * Исходный класс из кода Android Support Library версии 21.0.2
 * также см. <https://bitbucket.org/andreyice/swiperefreshlayoutbottom>
 * 
...
package nya.miku.wishmaster.lib.pullable_layout;
...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private OnEdgeReachedListener mOnEdgeListener; //добавлено
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                final float yDiff = Math.abs(y - mInitialMotionY); //изменено
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (mOnEdgeListener != null) mOnEdgeListener.onEdgeReached();
    ...
    /**
     * Этот интерфейс добавлен:
     * Callback-функция вызывается, когда достигнут край скроллинга, костыль нужен, т.к. в этом случае почему-то не всегда вызвается
     * ListView.OnScrollListener.onScrollStateChanged(ListView.OnScrollListener.SCROLL_STATE_IDLE)
     */
