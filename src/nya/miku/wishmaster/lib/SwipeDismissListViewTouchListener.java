...
//исправлен случай, когда высота элементов не задана числовым значением (WRAP_CONTENT или MATCH_PARENT)
/*
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mDismissAnimationRefCount == 0) {
                    ...
                    for (PendingDismissData pendingDismiss : mPendingDismisses) {
                        ...
                        lp.height = originalLayoutHeight; //восстанавливать значение высоты из параметров разметки (например, может быть WRAP_CONTENT)
