/*
 * Исходный класс: https://gist.github.com/pyricau/3424004 (Pierre-Yves Ricau)
 * 
 */
...
public class JellyBeanSpanFixTextView extends TextView {
    ...
    private static final String TAG = "JellyBeanSpanFixTextView";
    ...
    private void fixOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (text instanceof Spanned) {
            ...
            Logger.d(TAG, "The text isn't a Spanned");
    ...
    private FixingResult addSpacesAroundSpansUntilFixed(SpannableStringBuilder builder, int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Logger.d(TAG, "Could not fix the Spanned by adding spaces around spans");
    ...
    private void fallbackToString(int widthMeasureSpec, int heightMeasureSpec) {
        Logger.d(TAG, "Fallback to unspanned text");
