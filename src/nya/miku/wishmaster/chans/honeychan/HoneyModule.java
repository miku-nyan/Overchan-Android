...
/**
 * 
 * @author linearInsanity <https://github.com/linearInsanity>
 *
 */
public class HoneyModule extends AbstractVichanModule {
    ...
    private static final SimpleBoardModel[] BOARDS = new SimpleBoardModel[] {
        ...
        ChanModels.obtainSimpleBoardModel(CHAN_NAME, "mu", "Music", "", false),
        ChanModels.obtainSimpleBoardModel(CHAN_NAME, "l", "Learning Resources", "", false),
        ChanModels.obtainSimpleBoardModel(CHAN_NAME, "lewd", "Lewd", "", true),
    };
    private static final Pattern ERROR_PATTERN = Pattern.compile("<h2 [^>]*>(.*?)</h2>");

    public HoneyModule(SharedPreferences preferences, Resources resources) {
